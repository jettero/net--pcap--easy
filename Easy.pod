...
object and C<$header> is a L<Net::Pcap> header object.  Note that older versions
of C<Net::Pcap::Easy> do not support this additional argument.
...
Each C<Net::Pcap> object contains:
    C<{len}>     - Packet length,
    C<{tv_usec}> - Micro-seconds,
    C<{tv_sec}>  - Unix time (Seconds since 00:00:00 Jan 01, 1970),
    C<{caplen}>  - Capture length (Snaplength).
